function err=ELMfun(x,new_ptrain,Output_train,hiddennumber,new_ptest,Output_test)
%% 训练&测试BP网络
%% 输入
% x：一个个体的初始权值和阈值
% P：训练样本输入
...
[LW,TF,TYPE] = elmtrain2(new_ptrain,output_train,hiddennumber,activate_model,0,w1,B1);
%%  创建模型
