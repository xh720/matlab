...
%% %（1）未优化直接运行ELM结果
[T_train1,T_sim1,T_test1,T_sim01]=ELM(Input_train,Output_train,Input_test,Output_test,hiddennumber);

%% MIV 算法
[new_ptrain,new_ptest]=MIV(input_train,output_train,hiddennumber,input_test);

%% %（2）筛选后运行ELM结果
[T_train2,T_sim2,T_test2,T_sim02]=MIVELM(new_ptrain,Output_train,new_ptest,Output_test,hiddennumber);
...
%% 优化之后的ELM
[T_train3,T_sim3,T_test3,T_sim03]=GAELM(bestX,new_ptrain,Output_train,hiddennumber,new_ptest,Output_test);
